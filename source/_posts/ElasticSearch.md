...
1. 解压就可以使用了
   ...
   ![解压目录](picture/image-20210430190355544.png)
...
![](picture/20210831144336.png)

![启动](picture/image-20210430191321976.png)

![访问9200端口](picture/image-20210430191459782.png)
...
![](picture/20210502102631.png)

现在搜索to forever，只需要查看包含每个词条的文档

![](picture/20210502103014.png)
...
![ik_smart](picture/20210507105039.png)

![ik_max_word](picture/20210507105253.png)

> ik 分词器也可以增加自己的配置

![配置文件](picture/20210507105517.png)
...
![](picture/20210507105954.png)

![](picture/20210507110031.png)

扩展︰通过命令 elasticsearch 索引情况!通过 get _cat/ 可以获得es的当前的很多信息！

![](picture/20210507110145.png)
